const variants = [
  {
    id: "v1",
    label: "V1 — стилизованная иллюстрация",
    desc: "Cartoon-illustration с тёплым вайбом, изометрический офис с персонажами за столами. Не строго пиксель-арт, но в духе.",
  },
  {
    id: "v2",
    label: "V2 — ближе к пикселю",
    desc: "Самый «пиксельный» из всех — миниатюрный офис, мелкие фигурки, насыщенные цвета. Стилизация, но ближе к maxtreysi-вайбу.",
  },
];
    ...
    <div className="text-white">
      <div className="px-6 py-12 text-center sm:px-12">
        <p className="mb-2 text-xs font-medium uppercase tracking-widest text-yellow-400">
          ⚠️ Превью — выбор офиса для секции «Виртуальный офис»
        </p>
        <h1 className="text-3xl font-medium tracking-tight sm:text-4xl">
          Два варианта стилизованного офиса
        </h1>
        <p className="mt-3 max-w-2xl mx-auto text-sm text-white/60">
          Pollinations Flux не делает настоящий пиксель-арт, это «стилизация
          под пиксель». Если этого не хватает — пойдём за готовыми ассетами
          на itch.io или закажем художника.
        </p>
      </div>
