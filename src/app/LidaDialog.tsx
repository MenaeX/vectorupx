...
const messages: Msg[] = [
  {
    from: "lida",
    time: "10:12",
    text: "Дмитрий, добрый день. Видела в Хабре ваш кейс «АльфаПром» — расширили склад до 5 точек. Один из наших клиентов — производственная компания на 200 человек — делал похожее в 2025: после интеграции «Управления складом» цикл сборки заказа сократился на 40%. Если интересно — пришлю детали кейса. Вам будет удобно созвониться на 15 минут?",
  },
  {
    from: "lead",
    time: "12:48",
