...
const messages: Msg[] = [
  {
    from: "lida",
    time: "10:12",
    text: "Дмитрий, добрый день. Видел в Хабре ваш кейс «АльфаПром» — расширили склад до 5 точек. Один из наших клиентов (Бета-Логист, 200 чел) делал похожее в 2025: после интеграции «Управления складом» цикл сборки заказа сократился на 40%. Если интересно — пришлю детали кейса. Когда удобно 15 минут?",
  },
  {
    from: "lead",
    time: "12:48",
  ...
  },
  {
    from: "lida",
    time: "12:51",
    text: "Понял, не настаиваю. Один уточняющий вопрос: ваш программист поддерживает конфигурацию или развивает? Клиенты с похожим стажем приходят к нам именно тогда, когда штатный закрывает текучку, а на новые модули (WMS, B2B-портал) рук уже не хватает. Если узнаваемо — пришлю 3 варианта расширения за 15 минут.",
  },
  {
    from: "lead",
    time: "14:02",
  ...
  },
  {
    from: "lida",
    time: "14:03",
    text: "Отлично. Записал нас на четверг в 15:00 — короткая онлайн-встреча с Андреем (ведущим по проекту). Подходит?",
  },
  {
    from: "lead",
    time: "14:05",
  ...
  },
  {
    from: "lida",
    time: "14:05",
    text: "Записал. Ссылку пришлю в Telegram за 30 минут до встречи. До четверга.",
  },
];
